...
public class OftenTweets {
  ...
  public static class TokenizerMapper
    ...
    public void map(LongWritable key, Text value, Context context
      ...
      if ((pos_url != -1) && (pos_text != -1) && (pos_time != -1) && (pos_time + 2 < data.size())){
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "tweets time count");
    job.setJarByClass(OftenTweets.class);
